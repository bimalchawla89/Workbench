...
import arch.wb.retail.data.source.local.ProductsDatabase;
import arch.wb.retail.data.source.remote.RemoteSource;

/**
 * Enables injection of mock implementations for
 * {@link arch.wb.retail.data.source.AppDataSource} at compile time. This is useful for testing, since it allows us to use
